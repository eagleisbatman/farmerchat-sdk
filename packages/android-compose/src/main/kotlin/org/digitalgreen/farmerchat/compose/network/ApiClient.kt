...
internal class ApiClient(
    ...
    private companion object {
        ...
        val SDK_VERSION = org.digitalgreen.farmerchat.compose.FarmerChat.SDK_VERSION
    ...
    fun sendQuery(query: QueryRequest): Flow<SseEvent> = flow {
        ...
        try {
            ...
            if (contentType.contains("text/event-stream")) {
                        ...
                        when {
                            ...
                            line.isBlank() -> {
                                ...
                                if (currentEvent.isNotEmpty() && currentData.isNotEmpty()) {
                                    val event = SseEvent(event = currentEvent, data = currentData)
                                    emit(event)
                ...
                if (currentEvent.isNotEmpty() && currentData.isNotEmpty()) {
                    emit(SseEvent(event = currentEvent, data = currentData))
